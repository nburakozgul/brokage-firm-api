...
VALUES
    (1, 'ORD001', 'CUST001', 1,'Apple Inc.', 'PENDING', 'BUY', 175.50, 10, NOW(), NOW(), 'system', 'system'),
    (2, 'ORD002', 'CUST001', 1,'Apple Inc.', 'PENDING', 'SELL', 180.00, 5, NOW(), NOW(), 'system', 'system'),
    (3, 'ORD003', 'CUST002', 2,'Tesla Inc.', 'PENDING', 'BUY', 720.75, 2, NOW(), NOW(), 'system', 'system'),
    (4, 'ORD004', 'CUST003', 3,'Bitcoin', 'CANCELLED', 'BUY', 43000.00, 0.1, NOW(), NOW(), 'system', 'system');
